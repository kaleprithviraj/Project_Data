...
CREATE TABLE `customer_feedback` (
  ...
  `customer_feedback_date` datetime DEFAULT NULL,
  `customer_id` int DEFAULT NULL,
  `feedback_comment` varchar(255) DEFAULT NULL,
  KEY `order_id` (`order_id`),
  KEY `customer_id` (`customer_id`),
  CONSTRAINT `customer_feedback_ibfk_1` FOREIGN KEY (`order_id`) REFERENCES `order_info` (`order_id`),
  CONSTRAINT `customer_feedback_ibfk_2` FOREIGN KEY (`customer_id`) REFERENCES `customer_info` (`customer_id`)
...
-- Dump completed on 2022-02-25 19:37:53
